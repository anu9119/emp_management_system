...
# --- Admin Login Page ---
def login():
    if username_entry.get() == "admin" and password_entry.get() == "password":  # Simple check for demo
        show_frame(home_frame)
    else:
        messagebox.showerror("Login Failed", "Invalid Username or Password")

login_label = tk.Label(login_frame, text="Admin Login", font=("Arial", 16, "bold"))
...
home_label = tk.Label(home_frame, text="Northern Railway - Travelling Allowance Journal", font=("Arial", 16, "bold"), fg="blue")
...
tk.Label(top_section_frame, text="Top Section", font=("Arial", 14, "bold")).pack(pady=10)
...
tk.Label(certification_section_frame, text="Certification Section", font=("Arial", 14, "bold")).pack(pady=10)
...
tk.Button(certification_section_frame, text="Submit Certification", command=submit_certification, font=("Arial", 12, "bold"), bg="green", fg="white").pack(pady=10)
